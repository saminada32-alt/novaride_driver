    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Form(
          ...
          child: Column(
            children: [
              _field(_brand, t.brandLabel, Icons.branding_watermark),
              ...
              _field(
                ...
                validator: (v) {
                  ...
                  if (trimmed.isEmpty) return t.fieldRequired;
              ...
              const SizedBox(height: 14),
              _field(_plate, t.plateLabel, Icons.numbers),
              const SizedBox(height: 14),
              _field(_color, t.colorLabel, Icons.color_lens),
